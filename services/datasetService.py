...
# Dataset completo com dados limpos (duplicatas removidas)
dados = [
    # Anemia Falciforme (11 exemplos - 2 duplicatas removidas)
    ...
    # Artrite Reumatoide (13 exemplos - 2 duplicatas removidas)
    ...
    # Diabetes Tipo 1 (12 exemplos - 1 duplicata removida)
    ...
    # Doença de Alzheimer (10 exemplos - 3 duplicatas removidas)
    ...
    # Doença de Crohn (10 exemplos - 2 duplicatas removidas)
    ...
    # Doença de Lyme (10 exemplos - 4 duplicatas removidas)
    ...
    # Doença de Parkinson (11 exemplos - 2 duplicatas removidas)
    ...
    # Esclerose Lateral (9 exemplos - 2 duplicatas removidas)
    ...
    # Esclerose Múltipla (11 exemplos - 2 duplicatas removidas)
    ...
    ("cansaço severo fraqueza muscular visão dupla formigamento", "esclerose_multipla"),
    ...
    # Febre Maculosa (11 exemplos - 2 duplicatas removidas)
    ...
    # Hipotireoidismo (12 exemplos - 2 duplicatas removidas)
    ...
    # Lúpus (11 exemplos - 2 duplicatas removidas)
    ...
    # Miastenia Gravis (9 exemplos - 4 duplicatas removidas)
    ...
    ("perda de força muscular cansaço problemas visuais dificuldade de deglutição com tontura", "miastenia_gravis"),

    # Porfiria (10 exemplos - 2 duplicatas removidas)
    ...
    # Sarcoidose (11 exemplos - 3 duplicatas removidas)
    ...
    # Síndrome da Fadiga Crônica (9 exemplos - 4 duplicatas removidas)
    ...
    # Síndrome de Sjögren (10 exemplos)
